...
import { CreateRibEeffDto, UpdateRibEeffDto } from '@/types/ribEeff';
...
const RibEeffForm = () => {
  ...
  const activoFields = {
    activo_caja_inversiones_disponible: "Caja / Inversiones Disponibles",
    activo_cuentas_por_cobrar_del_giro: "Ctas. por Cobrar del Giro",
    activo_cuentas_por_cobrar_relacionadas_no_comerciales: "Ctas. por Cobrar Relacionadas (No Comerciales)",
    activo_cuentas_por_cobrar_personal_accionistas_directores: "Ctas. por Cobrar (Personal, Accionistas)",
    ...
    activo_cuentas_por_cobrar_comerciales_lp: "Ctas. por Cobrar Comerciales LP",
    activo_otras_cuentas_por_cobrar_diversas_lp: "Otras Ctas. por Cobrar Diversas LP",
  ...
  const pasivoFields = {
    pasivo_sobregiro_bancos_y_obligaciones_corto_plazo: "Sobregiro y Obligaciones CP",
    pasivo_parte_corriente_obligaciones_bancos_y_leasing: "Parte Corriente Obligaciones y Leasing",
    pasivo_cuentas_por_pagar_del_giro: "Ctas. por Pagar del Giro",
    pasivo_cuentas_por_pagar_relacionadas_no_comerciales: "Ctas. por Pagar Relacionadas (No Comerciales)",
    ...
    pasivo_parte_no_corriente_obligaciones_bancos_y_leasing: "Parte No Corriente Obligaciones y Leasing",
    pasivo_cuentas_por_pagar_comerciales_lp: "Ctas. por Pagar Comerciales LP",
    pasivo_otras_cuentas_por_pagar_diversas_lp: "Otras Ctas. por Pagar Diversas LP",
      ...
      <div className="min-h-screen bg-black text-white p-6">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center justify-between mb-6">
            ...
            <Button variant="outline" onClick={() => navigate('/rib-eeff')} className="border-gray-700 hover:bg-gray-800">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <Card className="bg-[#121212] border border-gray-800">
              <CardHeader>
                <CardTitle className="flex items-center"><Building className="h-5 w-5 mr-2 text-[#00FF80]" />Datos Generales</CardTitle>
              </CardHeader>
              <CardContent className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div>
                  <Label className="text-gray-300">Empresa (RUC)</Label>
                ...
                <div>
                  <Label className="text-gray-300">Tipo Entidad</Label>
                  <Select name="tipo_entidad" value={formData.tipo_entidad || ''} onValueChange={(value) => handleSelectChange('tipo_entidad', value)}>
                    <SelectTrigger className="bg-gray-900 border-gray-700 mt-1"><SelectValue placeholder="Seleccione..." /></SelectTrigger>
                    <SelectContent className="bg-[#121212] text-white border-gray-700">
