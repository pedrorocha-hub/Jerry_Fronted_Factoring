        ...
        <div className="space-y-6 p-6">
          ...
          {searchedFicha && documentData && (
            <div className="space-y-8">
              ...
              {/* Visor de Auditoría - Solo se muestra si existe un ID (modo edición) */}
              {isEditMode && id && (
                <Card className="bg-[#121212] border border-gray-800">
                  <CardHeader>
                    <CardTitle className="text-white">Auditoría y Trazabilidad</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <RibReporteTributarioAuditLogViewer reportId={id} />
                  </CardContent>
                </Card>
              )}
            </div>
