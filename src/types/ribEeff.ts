export type RibEeffTipoEntidad = 'proveedor' | 'deudor';
...
export interface RibEeff {
  ...
  created_at?: string;
  updated_at?: string;
  tipo_entidad?: RibEeffTipoEntidad | null;
  ruc: string;
...
export type CreateRibEeffDto = Omit<RibEeff, 'id' | 'created_at' | 'updated_at' | 'user_id'>;
